...
<div class="col-xl-2">
	<div class="indicator">
		<svg width="<?=$indicatorWidth?>" height="<?=$indicatorWidth?>" class="circle" viewbox="0 0 <?=$indicatorWidth?> <?=$indicatorWidth?>">
			<circle class="circle-bg" cx="<?=$indicatorWidth/2?>" cy="<?=$indicatorWidth/2?>" r="<?=$radius?>"></circle>
			<circle <?php if ( $color=='' ) { ?>
...
<div class="section-technologi">
	<div class="container pb-60 pt-60">
		<div class="row">
			<div class="col-xl-4 offset-3 mb-50 pl-30">
