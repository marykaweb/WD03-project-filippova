<div class="container">
	<div class="row">
		<div class="col-xl-10 offset-1">
			<div class="title-1 m-0 pt-60">Создать категорию</div>

			<?php require ROOT . "templates/_parts/errors.tpl"; ?>

			<form action="<?=HOST?>blog/categories-new" method="post" class="form mb-100 pb-20 pt-35">
				<div class="fieldset">
					<label>
						<div class="fieldset__title">Название категории</div>
						<input class="input" name="catTitle" placeholder="Введите название" />
					</label>
				</div>
				<div class="row">
